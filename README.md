...
**Protocol runtime for [AI-Protocol](https://github.com/ailib-official/ai-protocol)** — high-performance Rust reference implementation (v**1.3.0**).
...
> **Pin:** Prefer crates.io **1.3.0** (tag `v1.3.0`). CI pins `ai-protocol` **v1.2.0**. See [CHANGELOG](CHANGELOG.md).
